...
if [ $SKIP_COM -eq 0 ]; then
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/jtag_uart_jtag_uart.v" -work jtag_uart -cdslib ./cds_libs/jtag_uart.cds.lib

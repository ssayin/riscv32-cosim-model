...
proc cr_bd_ex_sim { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.HAS_RRESP {1} \
    CONFIG.HAS_SIZE {0} \
    CONFIG.HAS_USER_BITS_PER_BYTE {1} \
    CONFIG.HAS_WSTRB {1} \
    CONFIG.ID_WIDTH {0} \
  ...
  assign_bd_address -offset 0x00000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces axi_vip_mst/Master_AXI] [get_bd_addr_segs axi_vip_slv/S_AXI/Reg] -force

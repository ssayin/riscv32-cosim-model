...
// You can insert code here by setting trans_inc_before_class in file riscv_core.tpl
...
function string riscv_core_tx::convert2string();
  ...
  $sformat(s, {"%s\n",
    ...
    "mem_addr     = %p\n"},         
    get_full_name(), mem_data_in, mem_ready, mem_ready, irq_external, irq_external, irq_timer, irq_timer, irq_software, irq_software, mem_data_out, mem_wr_en, mem_rd_en, mem_clk_en, mem_clk_en, mem_addr);
  return s;

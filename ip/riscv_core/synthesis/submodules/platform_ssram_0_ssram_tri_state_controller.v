// platform_ssram_0_ssram_tri_state_controller.v
...
`timescale 1 ps / 1 ps
module platform_ssram_0_ssram_tri_state_controller #(
		parameter TCM_ADDRESS_W                  = 20,
		parameter TCM_DATA_W                     = 32,
		parameter TCM_BYTEENABLE_W               = 4,
		parameter TCM_READ_WAIT                  = 3,
		parameter TCM_WRITE_WAIT                 = 3,
		parameter TCM_SETUP_WAIT                 = 3,
		parameter TCM_DATA_HOLD                  = 3,
		parameter TCM_TURNAROUND_TIME            = 2,
		parameter TCM_TIMING_UNITS               = 1,
		parameter TCM_READLATENCY                = 3,
		...
		input  wire [19:0] uas_address,             //   uas.address
		...
		output wire [19:0] tcm_address_out,         //      .address_out
	...
	wire  [19:0] tdt_avalon_universal_master_0_address;              // tdt:m0_uav_address -> slave_translator:uav_address
	...
	wire  [19:0] slave_translator_avalon_anti_slave_0_address;       // slave_translator:av_address -> tda:av_address
